...
final class CreateCheckingAccount extends JPanel {
    ...
    public CreateCheckingAccount() {
        ...
        createAccountLabel = new JLabel("Create checking Account");
    ...
    public JLabel getAccountNameLabel() { return accountNameLabel; }
